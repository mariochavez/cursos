...
group :bridgetown_plugins do
  gem "bridgetown-feed", "~> 2.1", git: "https://github.com/mariochavez/bridgetown-feed", branch: "custom"
  gem "bridgetown-sitemap", "~> 1.1"
  gem "bridgetown-seo-tag", "~> 5.0", git: "https://github.com/mariochavez/bridgetown-seo-tag", branch: "custom"
end
